	...
	<script type="text/javascript">
		...
		<div style="position:absolute;width:30vw;left:68vw">
			...
			<div style="top:9.5vw;width:20vw;height:30vw;position:absolute;background-size:18vw 28vw;background-image:url(instrucciones.png);background-repeat:no-repeat">
 			...
 			<div onclick="javascript:window.open('https://storage.googleapis.com/testplayaddition.appspot.com/HOW_TO_PLAY_LEVEL_<%=nivel%>.mp4', '_blank', 'toolbar=no,scrollbars=no,resizable=no,top=150,left=300,width=600,height=400');" style="width:8.5vw;height:6.5vw;position:absolute;left:0.5vw;cursor:pointer;background-size:8.5vw 6.5vw;top:38.25vw;background-image:url(howToplay.png);background-repeat:no-repeat"></div>
