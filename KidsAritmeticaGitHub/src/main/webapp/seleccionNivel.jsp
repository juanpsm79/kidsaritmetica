  ...
  <body onload="seleccionarNivel('1')">
		...
		<div style="width:1140px;height:750px">
			...
			<div style="width:1140px;height:95px">
	  			<div id="1" onclick="seleccionarNivel('1')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
	  			background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100)">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('1')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="2" onclick="seleccionarNivel('2')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:4px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('2')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="3" onclick="seleccionarNivel('3')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:10px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('3')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="4" onclick="seleccionarNivel('4')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:14px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('4')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="5" onclick="seleccionarNivel('5')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:18px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('5')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="6" onclick="seleccionarNivel('6')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:22px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('6')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="7" onclick="seleccionarNivel('7')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:26px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('7')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="8" onclick="seleccionarNivel('8')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:30px">
					<div style="text-align:center">
							<label onclick="seleccionarNivel('8')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:18px;font-weight:bold">LEVEL</label>
					</div>
				...
				<div id="9" onclick="seleccionarNivel('9')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				...
				<div id="10" onclick="seleccionarNivel('10')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
 			...
 			<div style="width:1140px;height:95px;position: relative;bottom: 4px;">
	  			<div id="11" onclick="seleccionarNivel('11')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
	  			background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100)">
					<div style="text-align:center">
				...
				<div id="12" onclick="seleccionarNivel('12')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:4px">
					<div style="text-align:center">
				...
				<div id="13" onclick="seleccionarNivel('13')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:10px">
					<div style="text-align:center">
				...
				<div id="14" onclick="seleccionarNivel('14')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:14px">
					<div style="text-align:center">
				...
				<div id="15" onclick="seleccionarNivel('15')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:18px">
					<div style="text-align:center">
				...
				<div id="16" onclick="seleccionarNivel('16')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:22px">
					<div style="text-align:center">
				...
				<div id="17" onclick="seleccionarNivel('17')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:26px">
					<div style="text-align:center">
				...
				<div id="18" onclick="seleccionarNivel('18')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:30px">
					<div style="text-align:center">
				...
				<div id="19" onclick="seleccionarNivel('19')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:34px">
					<div style="text-align:center">
				...
				<div id="20" onclick="seleccionarNivel('20')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:38px">
					<div style="text-align:center">
  			...
  			<div style="width:1140px;height:95px;position: relative;bottom: 4px;">
	  			<div id="21" onclick="seleccionarNivel('21')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
	  			background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100)">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('21')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">11</label>
					</div>
				</div>
				
				<div id="22" onclick="seleccionarNivel('22')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:4px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('22')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">12</label>
					</div>
				</div>
				
				<div id="23" onclick="seleccionarNivel('23')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:10px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('23')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">13</label>
					</div>
				</div>
				
				<div id="24" onclick="seleccionarNivel('24')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:14px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('24')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">14</label>
					</div>
				</div>
				
				<div id="25" onclick="seleccionarNivel('25')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:18px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('25')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">15</label>
					</div>
				</div>
				
				<div id="26" onclick="seleccionarNivel('26')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:22px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('26')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">16</label>
					</div>
				</div>
				
				<div id="27" onclick="seleccionarNivel('27')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:26px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('27')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">17</label>
					</div>
				</div>
				
				<div id="28" onclick="seleccionarNivel('28')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:30px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('28')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">18</label>
					</div>
				</div>
				
				<div id="29" onclick="seleccionarNivel('29')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:34px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('29')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">19</label>
					</div>
				</div>
				
				<div id="30" onclick="seleccionarNivel('30')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:38px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('30')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">20</label>
					</div>
				</div>
 			</div>			
 			...
 			<div style="width:1140px;height:95px;position: relative;bottom: 4px;">
	  			<div id="31" onclick="seleccionarNivel('31')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
	  			background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100)">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('31')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">11</label>
					</div>
				</div>
				
				<div id="32" onclick="seleccionarNivel('32')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:4px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('32')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">12</label>
					</div>
				</div>
				
				<div id="33" onclick="seleccionarNivel('33')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:10px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('33')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">13</label>
					</div>
				</div>
				
				<div id="34" onclick="seleccionarNivel('34')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:14px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('34')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">14</label>
					</div>
				</div>
				
				<div id="35" onclick="seleccionarNivel('35')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:18px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('35')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">15</label>
					</div>
				</div>
				
				<div id="36" onclick="seleccionarNivel('36')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:22px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('36')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">16</label>
					</div>
				</div>
				
				<div id="37" onclick="seleccionarNivel('37')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:26px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('37')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">17</label>
					</div>
				</div>
				
				<div id="38" onclick="seleccionarNivel('38')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:30px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('38')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">18</label>
					</div>
				</div>
				
				<div id="39" onclick="seleccionarNivel('39')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:34px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('39')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">19</label>
					</div>
				</div>
				
				<div id="40" onclick="seleccionarNivel('40')" style="width:100px;height:95px;float:left;background-image:url(fondoNivelNormal.png);
				background-repeat:no-repeat;text-align: center;border: 4px solid;border-color:rgb(32, 56, 100);
				position:relative;right:38px">
					<div style="text-align:center">
					...
					<div style="text-align:center">
							<label onclick="seleccionarNivel('40')" style="cursor:pointer;position:relative;color:white;font-family:Calibri;font-size:44px;font-weight:bold">20</label>
					</div>
				</div>
 			</div>
