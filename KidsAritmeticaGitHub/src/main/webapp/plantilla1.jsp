  ...
  <body onload="javascript:calcularSuma()">
	<div>
			...
			<div style="width:90%;height:70%">
				<div style="width:35%;height:100%;float:left;background-image:url(marcador.png);background-repeat:no-repeat">
				</div>	
				
				<div style="width:40%;height:100%;float:left;background-image:url(cuadroSuma1.png);background-repeat:no-repeat">
				</div>
				
				<div style="width:25%;height:100%;float:left;background-image:url(cerrarAspa.png);background-repeat:no-repeat">
				</div>
			...
			<div style="width:90%;height:30%">
					...
					<div style="float:left;width:25%;height:100%;background-image:url(checkBoton.png);background-repeat:no-repeat;position:relative;bottom:30px">
					</div>
			</div>
