	...
	<script type="text/javascript">
		...
		<div id="capaNiveles" style="position:absolute;width:75vw;top:14.5vw"> 
 		...
 		<div id="pantallaCompletaDiv" style="position:absolute;width:14vw;top:1vw;left:85vw">
 			...
 			<div id="pantallaCompleta" ontouchstart="fullscreen(this)" style="visibility:hidden;position:absolute;left:11vw;cursor:pointer;width:5vw;height:5vw;background-size:5vw 5vw;background-repeat:no-repeat">
